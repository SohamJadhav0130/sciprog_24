...
// Making TanArr and N a global variable
int N = 12;
float TanArr[13];
...
int main(void)
{
    ...
    // calculate the area at pts x1, x2, x3 till, x11 and add them up.
    int i;
    for (i = 0; i < N; i++)
    {
        deg = i * 5;
    ...
    // Printing the approximated result
    printf("\n Trapezoidal result is: %f\n", area);
    // Integral of tan is log(2)
